...
namespace NinjaBattle.UI.Editor
{
    public static class MissionProgressionUIAuthoring
    {
        ...
        private static readonly Color Gold = new Color(0.95f, 0.67f, 0.11f, 1f);
        private static readonly Color BrightGold = new Color(1f, 0.84f, 0.26f, 1f);
        private static readonly Color DeepGreen = new Color(0.015f, 0.12f, 0.085f, 0.98f);
        private static readonly Color CardGreen = new Color(0.02f, 0.20f, 0.14f, 0.98f);
        ...
        public static void Build()
        {
            ...
            Image hud = CreateImage("ProgressionHUD", root, hudSprite, Color.white);
            ...
            Anchor(openButton.GetComponent<RectTransform>(), new Vector2(0f, 0.5f), new Vector2(0f, 0.5f),
                new Vector2(0.5f, 0.5f), new Vector2(150f, 14f), new Vector2(108f, 82f));
            ...
            Anchor(badgeBorder.rectTransform, new Vector2(1f, 0.5f), new Vector2(1f, 0.5f),
                new Vector2(0.5f, 0.5f), new Vector2(-82f, 2f), new Vector2(126f, 88f));
            ...
            RTLTextMeshPro levelText = CreateText("LevelText", levelBadge.transform, "سطح ۱", 23, BrightGold,
                TextAlignmentOptions.Center);
            ChatUiFactory.Stretch(levelText.rectTransform);

            RTLTextMeshPro titleText = CreateText("TitleText", hud.transform, "توریست", 25, Cream,
                TextAlignmentOptions.Center);
            Anchor(titleText.rectTransform, new Vector2(0.5f, 1f), new Vector2(0.5f, 1f),
                new Vector2(0.5f, 1f), new Vector2(20f, -17f), new Vector2(390f, 36f));
            ...
            Anchor(xpTrack.rectTransform, new Vector2(0.5f, 0f), new Vector2(0.5f, 0f),
                new Vector2(0.5f, 0f), new Vector2(20f, 17f), new Vector2(400f, 14f));
            ...
            RTLTextMeshPro xpText = CreateText("XpText", hud.transform, "۴۲ از ۱۰۰ امتیاز", 17, Cream,
                TextAlignmentOptions.Center);
            Anchor(xpText.rectTransform, new Vector2(0.5f, 0f), new Vector2(0.5f, 0f),
                new Vector2(0.5f, 0f), new Vector2(20f, 40f), new Vector2(400f, 26f));
            ...
            Image panelBorder = ChatUiFactory.Panel("PanelBorder", dimmer.transform, Gold);
            Anchor(panelBorder.rectTransform, new Vector2(0.5f, 0.5f), new Vector2(0.5f, 0.5f),
                new Vector2(0.5f, 0.5f), Vector2.zero, new Vector2(930f, 1320f));

            Image panel = ChatUiFactory.Panel("Panel", panelBorder.transform, DeepGreen);
            panel.raycastTarget = true;
            panel.rectTransform.anchorMin = Vector2.zero;
            panel.rectTransform.anchorMax = Vector2.one;
            panel.rectTransform.offsetMin = new Vector2(7f, 7f);
            panel.rectTransform.offsetMax = new Vector2(-7f, -7f);

            Image header = CreateImage("Header", panel.transform,
                LoadAtlasSprite("Copilot_20260508_152525 (2)_9"), Color.white);
            Anchor(header.rectTransform, new Vector2(0.5f, 1f), new Vector2(0.5f, 1f),
                new Vector2(0.5f, 1f), new Vector2(0f, -48f), new Vector2(570f, 150f));
            ...
            Anchor(closeButton.GetComponent<RectTransform>(), new Vector2(0f, 1f), new Vector2(0f, 1f),
                new Vector2(0.5f, 0.5f), new Vector2(66f, -66f), new Vector2(76f, 76f));
            ...
            Anchor(summaryText.rectTransform, new Vector2(0.5f, 1f), new Vector2(0.5f, 1f),
                new Vector2(0.5f, 1f), new Vector2(0f, -185f), new Vector2(650f, 44f));
        ...
        {
            Image outer = ChatUiFactory.Panel("MissionItemTemplate", parent, Gold);
            LayoutElement layout = outer.gameObject.AddComponent<LayoutElement>();
            layout.preferredHeight = 235f;
            layout.minHeight = 235f;
            ...
            Image rewardBadge = ChatUiFactory.Panel("RewardBadge", card.transform, new Color(0.42f, 0.07f, 0.04f, 1f));
            ...
            Anchor(progressTrack.rectTransform, new Vector2(0f, 0f), new Vector2(1f, 0f),
                new Vector2(0.5f, 0f), new Vector2(0f, 28f), new Vector2(-70f, 22f));
        ...
        {
            if (Object.FindAnyObjectByType<MissionManager>(FindObjectsInactive.Include) == null)
            {
                GameObject missionManager = new GameObject("MissionManager", typeof(MissionManager));
                Undo.RegisterCreatedObjectUndo(missionManager, "Create MissionManager");
            }
